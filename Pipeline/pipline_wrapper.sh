...
bowtie2-build GCF_000001405.40_GRCh38.p14_genomic_part.fa $DATA_DIR/reference_index
...
freebayes -f GCF_000001405.40_GRCh38.p14_genomic_part.fa $DATA_DIR/sorted_output.bam > $DATA_DIR/output.vcf
