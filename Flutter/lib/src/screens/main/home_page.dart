...
class _HomePageState extends State<HomePage> {
  ...
  void loadVariants() async {
    var data = await loadGeneVariants();
    setState(() {
      geneVariantList = data;
    });
  }
                  ...
                  if (!uniqueGeneVariants.contains(medicament.geneVariant)) {
                    ...
                    uniqueContainers.add(GestureDetector(
                      onTap: () {
                        ...
                        Get.to(
                            GenomeDescription(genome: medicament.geneVariant));
                      },
                      child: Container(
                              ...
                              GestureDetector(
                                onTap: () {
                                  ...
                                  Get.to(MedicineDescription(
                                      drugs: filteredMedicaments.drugs));
                                },
                                child: Container(
                                  width:
