...
def numpy_array_to_json(numpy_array):
    ...
    result = []
    for variation in python_list:
       result.append({'GeneVariant': variation})
...
def run_comparison():
    # VCF file name
    vcf_file = '/Users/ahmedabouismail/Documents/Uni/Semester_2/Frameworke/Project_2/mobile-app-for-public-health/backend/genome_comparison/output_CYP2D6_CYP2C19.vcf'
